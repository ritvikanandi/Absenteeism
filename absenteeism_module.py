# -*- coding: utf-8 -*-
"""Absenteeism_module.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_09q2Y-4p5c_J9H4VX5Vn8O5ht5mf7sc
"""
...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            column_names_reordered = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'Month of absence', 'Day of the week', 'Seasons',
                'Transportation expense', 'Distance from Residence to Work',
              'Service time', 'Age', 'Work load Average/day ', 'Hit target',
              'Disciplinary failure', 'Education', 'Son', 'Social drinker',
              'Social smoker', 'Pet', 'Weight', 'Height', 'Body mass index',
            ...
            df = df.loc[df['Month of absence'] != 0]
